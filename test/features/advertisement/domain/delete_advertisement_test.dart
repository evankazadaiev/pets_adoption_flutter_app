...
import 'package:pets_adoption/features/advertisement/domain/usecases/delete_advertisement.dart';
...
void main() {
  ...
  group("DeleteAdvertisement", () {
    ...
    test("should call [deleteAdvertisement] from the repo", () async {
      when(() => mockAdvertisementRepository.deleteAdvertisement(any()))
      ...
      verify(() => mockAdvertisementRepository.deleteAdvertisement(testId));
